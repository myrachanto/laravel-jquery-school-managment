...
class ExpenceflowsController extends Controller
{
      public function __construct(){
	    ...
	    public function index()
	    {
            ...
            return view('/Accounts/finances/expenceflows/index')->with('expenceflows',$expenceflows);
	    }
	    public function fee()
	    {
            $expenceflows = Expenceflow::all();
            return view('/Accounts/finances/fee')->with('expenceflows',$expenceflows);
	    }
	 public function part1()
	{	
		return View::make('Accounts.finances.part1');
	}
	public function invoicelist()
	{	
		return View::make('Accounts.finances.invoicelist');
	}
	...
	{	
		...
		$year = $invo->year;
		$term = $invo->term;
		return View::make('Accounts.finances.invoice')
	...
	public function part2(Request $request){
		...
		$term = $request->term;
        $expence = Expence::all();
		return View::make('Accounts.finances.part2')
	...
	public function part3(Request $request){
        ...
        $expence = Expence::all();
		return View::make('Accounts.finances.part3')
			->with('expence', $expence)
			->with('invoiceno', $invoiceno);
	}
