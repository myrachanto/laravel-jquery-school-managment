...
<div id="about" class="container-fluid carodiv2">
     ...
     <div class="panel-heading">Upload the subject photo</div> 
            <div class="panel-body">
            <form action="{{ url('/admin/subject/upload') }}" method="post" enctype="multipart/form-data" >
        <div class="form-group">
                  ...
                  @if($subject -> count()>=1 )
                   <div class="form-group">
                  <label for="foto">subject photo:</label>
    ...
    <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('/admin/subject/view')}}">
    <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('/admin/subject/delete')}}">
    ...
    <div class="modal fade" id="editModal" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('/admin/subject/update') }}" method="post">
