...
<div id="about" class="container-fluid carodiv2">
     ...
     <div class="panel-heading">Upload the Carrer photo</div> 
            <div class="panel-body">
            <form action="{{ url('/admin/career/upload') }}" method="post" enctype="multipart/form-data" >
        <div class="form-group">
                  ...
                  @if($career -> count()>=1 )
                   <div class="form-group">
                  <label for="foto">career photo:</label>
    ...
    <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('/admin/career/view')}}">
    <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('/admin/career/delete')}}">
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('/admin/career') }}" method="post">
               <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="form-group">
    ...
    <div class="modal fade" id="editModal" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('/admin/career/update') }}" method="post">
