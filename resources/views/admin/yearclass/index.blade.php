...
<div id="about" class="container-fluid carodiv2">
     ...
     <div class="panel-heading">Upload the year class photo</div> 
            <div class="panel-body">
            <form action="{{ url('/admin/yearclass/upload') }}" method="post" enctype="multipart/form-data" >
        <div class="form-group">
                    <label for="category">Student:</label>
                    <select class="form-control" id="yearclassid" name="yearclassid">
                      @foreach($yearclass as $y)
                      <option value="{{$y -> id}}">{{$y -> name}}</option>
                      @endforeach
                    </select>
                  </div>
                  @if($yearclass -> count()>=1 )
                   <div class="form-group">
                  <label for="foto">year class photo:</label>
    ...
    <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('/admin/yearclass/view')}}">
    <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('/admin/yearclass/delete')}}">
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('/admin/yearclass') }}" method="post">
               <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="form-group">
                  <label for="name"> Name:</label>
                  <input type="text" class="form-control" id="name" name="name" placeholder="year2006-2009">
                </div>  
              <div class="form-group">
                     <div class="form-group">
                  <label for="description">Description:</label>
                <textarea class="form-control" rows="5" id="description" name="description"  placeholder="Describe the class"></textarea>
                </div>
    ...
    <div class="modal fade" id="editModal" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('/admin/yearclass/update') }}" method="post">
