...
<div id="about" class="container-fluid carodiv2">
    ...
    <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('/admin/yos/view')}}">
    <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('/admin/yos/delete')}}">
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Add A new Year of study</h4>
          </div>
          <div class="modal-body">
            <form action="{{ url('/admin/yos') }}" method="post">
    ...
    <div class="modal fade" id="viewModal" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">View Year of study</h4>
          </div>
          <div class="modal-body">
    ...
    <div class="modal fade" id="editModal" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('/admin/yos/update') }}" method="post">
