...
<div id="about" class="container-fluid carodiv2">
    ...
    <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('/admin/classes/view')}}">
    <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('/admin/classes/delete')}}">
    ...
    <div class="modal fade" id="editModal" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ url('/admin/classes/update') }}" method="post">
