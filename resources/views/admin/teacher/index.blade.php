...
<div id="about" class="container-fluid carodiv2">
     ...
     <div class="panel-heading">Upload the Teacher photo</div> 
            ...
            <form action="{{ url('/admin/teacher/upload') }}" method="post" enctype="multipart/form-data" >
        <div class="form-group">
                  ...
                  @if($user -> count()>=1 )
                   <div class="form-group">
                  <label for="foto">Teacher photo:</label>
    ...
    <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('/admin/teacher/delete')}}">
