...
<nav class="navbar navbar-fixed-top">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="{{url('/')}}">Chantos E-school</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
        <li><a href="{{url('/')}}">Home</a></li>
        <li><a href="{{url('/aboutus')}}">About us</a></li>
        <li><a href="{{url('/careers')}}">Curriculum</a></li>
        <li><a href="{{url('/portfolio')}}">Extra-Curriculum</a></li>
        <li><a href="{{url('/careers')}}">Galley</a></li>
        <li><a href="#">Blog</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">    <!-- Authentication Links -->
                    @if (auth()->guard('account')->user())
                           <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">{{auth()->guard('account')->user()->username}}
...
<table class="table">
      ...
      <tr>
      <td><a href="{{url('/Accounts/Dashboard')}}"><div>Dashboard</div></a></td></tr><tr>
      <td><a href="{{url('/Accounts/expence')}}"><div>Fee contents</div></a></td></tr><tr>
      <td><a href="{{url('/Accounts/expenceflows')}}"><div>Fee Distribution</div></a></td></tr><tr>
      <td><a href="{{url('/Accounts/finances/invoicelist')}}"><div>Invoices</div></a></td></tr><tr>
      <td><a href="{{url('/Accounts/finances')}}"><div>Dashboard</div></a></td></tr><tr>
      </tr>
      </table></td>
      <td class="col-sm-10">
...
<div class="container-fluid " style="background-color:#CCC; color:#000" >
            ...
            <h4>Our work</h4>
        	@yield('urls')<br /><br /><br /><br />
        <p>Design and Developed by : <a href="http://www.chantosweb.com">Chantosweb.com</a></p>
              </div>
              <div class="col-lg-4" align="left">
        <p><a href="{{url('/teacher-login')}}">admininstration</a></p>
        <p><a href="{{url('/account-login')}}">Accounting</a></p>
 ...
 <p>Share on</p>
  ...
  <li><a href="http://www.linkedin.com/shareArticle?mini=true&url=&title=&summary=&source=" target="_blank" title="Share on LinkedIn" onclick="window.open('http://www.linkedin.com/shareArticle?mini=true&url=' + encodeURIComponent(document.URL) + '&title=' +  encodeURIComponent(document.title)); return false;"><img alt="Share on LinkedIn" src="{{asset('img/social_flat_rounded_rects_svg/LinkedIn.svg')}}"></a></li>
        ...
        <h4>Contact</h4>
           <table><tr><td><img src="{{asset('img/contact.jpg')}}" width="60" height="60" alt="myrachanto"/></td><td> <p><strong>Email</strong> <a href="mailto:info@chantosweb.com">info@chantosweb.com</a><br />
             <strong>Contact:</strong>		+254729308456<br />
             <strong>Web site</strong> 	<a href="mailto:info@privine.co.ke">www.chantosweb.com</a><br />
