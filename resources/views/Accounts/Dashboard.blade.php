   ...
   <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a href="{{ url('/Accounts/finances/paymentflow') }}">
                        ...
                        <a href="{{ url('/Accounts/finances/fees') }}">
                            <div class="panel-footer">
                  ...
                  <div class="col-lg-6 col-md-6">
                    <div class="panel panel-default">
                        ...
                        <a href="{{ url('/Accounts/expence') }}">
                            ...
                            <a href="{{ url('/Accounts/finances/invoicelist') }}">
                            <div class="panel-footer">
